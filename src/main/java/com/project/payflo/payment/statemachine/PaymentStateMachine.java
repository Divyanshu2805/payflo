...
import com.project.payflo.common.exception.InvalidStateTransitionException;
...
public class PaymentStateMachine {
    ...
    private static final Map<Transition, PaymentStatus> TRANSITION = Map.ofEntries(
            ...
            Map.entry(new Transition(PaymentStatus.CAPTURING, PaymentEvent.CAPTURE_PENDING), PaymentStatus.CAPTURING),
