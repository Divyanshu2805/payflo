...
signup and API key management, order creation, lookup, cancellation, and payment listing/initiation);
the rest of the repository/service/API layer is still to come.
