...
**Next up:** hashing for the signup password and API key secret, merchant login, scheduling the
already-built `BankCallbackSimulator` (currently disabled — see [Known
gaps](gaps.md)) so payments actually resolve, and the rest of the
