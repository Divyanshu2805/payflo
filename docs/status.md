...
**Next up:** hashing for the signup password and API key secret, merchant login, deciding what a
synchronous `Success` should map to for netbanking/UPI (see [Known
gaps](gaps.md)), and the rest of the payment lifecycle (list
orders, refund).
